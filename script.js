    ...
    education: [
        {
            ...
            description: "Currently pursuing degree with a focus on Web Technologies and System Design."
        }
    ],
    experience: [
        {
            ...
            tasks: [
                "Developed and maintained code for client websites.",
                "Collaborated with design team to create modern UIs."
            ]
        }
    ],
    techStack: [
        { name: "HTML5", colorClass: "group-hover:text-orange-500" },
        { name: "CSS3", colorClass: "group-hover:text-blue-500" },
        { name: "JavaScript", colorClass: "group-hover:text-yellow-400" },
        { name: "React", colorClass: "group-hover:text-cyan-400" },
        { name: "Node.js", colorClass: "group-hover:text-green-500" },
        { name: "GitHub", colorClass: "group-hover:text-white" }
    ],
    projects: [
        {
            title: "E-Commerce Platform",
            description: "A full-stack e-commerce solution with cart functionality, user authentication, and payment gateway integration.",
            stack: ["React", "Node", "MongoDB"],
            images: [
                "https://placehold.co/600x400/1a1a1a/FFF?text=Project+One+1",
        ...
        },
        {
            ...
            description: "Real-time weather tracking application utilizing open weather APIs and AI for basic forecasting.",
...
function renderTechStack() {
    ...
    if (!container) return;
    container.innerHTML = data.techStack.map((tech, index) => `
